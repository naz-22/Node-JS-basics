...
async function addOrder(order) {
    try {
        ...
        .input("Mesage",sql.NVarChar,order.Mesage)
        .input("City",sql.NVarChar,order.City)
        .query("INSERT INTO Products.dbo.Orders (Id, Title, Quantity, Mesage, City) VALUES (@Id, @Title, @Quantity,  @Mesage, @City);")
...
async function updateOrder(order) {
    try {
        ...
        .input("Mesage",sql.NVarChar,order.Mesage)
        .input("City",sql.NVarChar,order.City)
        .query("UPDATE Orders SET Title=@Title, Quantity =@Quantity, Mesage = @Mesage, City= @City  WHERE Id=@Id")
